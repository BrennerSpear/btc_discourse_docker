...
images = {
  ...
  discourse: { name: 'discourse', tag: "brennerspear/discourse:#{version}", squash: true, layers_to_keep: 1 },
  discourse_test: { name: 'discourse_test', tag: "brennerspear/discourse_test:#{version}", squash: true, layers_to_keep: 2 },
  discourse_dev: { name: 'discourse_dev', tag: "brennerspear/discourse_dev:#{version}", squash: false },
  discourse_bench: { name: 'discourse_bench', tag: "brennerspear/discourse_bench:#{version}", squash: false }
}
